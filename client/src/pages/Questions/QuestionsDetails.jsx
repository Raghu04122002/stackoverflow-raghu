...
const QuestionsDetails = () => {
    ...
    const url = 'https://stack-overflow-raghu.netlify.app/'
                                    ...
                                    <div style={{width: "100%"}}>
                                        ...
                                        <div className="question-actions-user">
                                            ...
                                            <Link to={`/Users/${question.userId}`} className='user-link' style={{color:'#0086d8'}}>
                                                        <Avatar backgroundColor="orange" px='7px' py='15px' borderRadius="5px">{question.userPosted.charAt(0).toUpperCase()}</Avatar>
                                                        <div>
                                                            {question.userPosted}
                                                        </div>
                                            </Link>
